...
function build_kernel()
{
    ...
    #make-3.81 -j1 ARCH=arm CROSS_COMPILE=$KERNEL_CROSS_COMPILE_PATH
...
{
        echo
        echo '[[[[[[[ Build android openGl and libs ]]]]]]]'
        echo
        ...
        source build/envsetup.sh
        echo
        echo "lunch $PRODUCT_BOARD-eng"#ifdef TASK_LOGGER
        lunch $PRODUCT_BOARD-eng
        echo
        echo "make-3.81 -j$(expr $CPU_JOB_NUM \* 2) libsurfaceflinger libEGL"
        echo
        make-3.81 -j$(expr $CPU_JOB_NUM \* 2) libsurfaceflinger libEGL
        check_exit
...
function build_systemui()
{
        echo
        echo '[[[[[[[ Build android SystemUI ]]]]]]]'
        echo
        ...
        lunch $PRODUCT_BOARD-eng
        echo
        echo "make-3.81 -j$(expr $CPU_JOB_NUM \* 2) systemui"
        echo
        make-3.81 -j$(expr $CPU_JOB_NUM \* 2) libinfo_jni libpoweroff_jni SystemUI
        check_exit
